...
export const EditCourse = () => {
    ...
    if (loading) return <div className="container" style={{ marginTop: '2rem' }}>Loading course...</div>;
    if (!formData.title && !loading) return <div className="container" style={{ marginTop: '2rem' }}>Course not found.</div>;
